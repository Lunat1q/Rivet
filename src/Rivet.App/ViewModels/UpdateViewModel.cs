...
/// behind the user's back — and never mid-transcode or mid-render.
/// </summary>
public sealed partial class UpdateViewModel : ObservableObject
{
    ...
    public string Headline => Available is null
        ? string.Empty
        : $"Rivet {Available.Version} is available ({Available.SizeText}).";
    ...
    private async Task InstallAsync()
    {
        ...
        try
        {
            // The app exits inside here: the installer cannot replace an exe that is running.
